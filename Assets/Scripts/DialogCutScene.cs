    ...
    public void TextUdate()
    {
        ...
        switch (textChanger)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                text.text = "На север в четыре километра до башни климатконтроля, от неё 7 на восток до скалистой греды. Используй один из тех байков, я загружу необходимый маршрут";
                textChanger++;
                break;
            case 5:
